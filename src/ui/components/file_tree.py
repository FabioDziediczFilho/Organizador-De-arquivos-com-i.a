...
class FileTreeWidget(QTreeWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Lista para manter referências fortes dos FileItems e evitar que sejam deletados pelo Garbage Collector (PySide6 crash)
    ...
    def load_files(self, file_data: List):
        ...
        for data in file_data:
            ...
            self._loaded_files.append(file_item)
    ...
    def clear(self):
        """Limpa a árvore e libera referências aos arquivos."""
        super().clear()
